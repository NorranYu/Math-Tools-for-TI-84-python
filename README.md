All three .py files are written using simpler functions, making them compatible with the *Texas Instruments 84 Plus CE Python Edition* graphing calculator.
